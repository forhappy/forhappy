...
function reposidget(obj) {
    ...
    container.innerHTML = '<div class="reposidget-header"><h2><a href="https://github.com/' + repoinfo.owner.login + '">' + repoinfo.owner.login + '</a>&nbsp;/&nbsp;<strong><a href="' + repoinfo.html_url + '">' + repoinfo.name + '</a></strong>' + '<span class="social"><span class="star">' + format(repoinfo.watchers_count) + '</span><span class="fork">' + format(repoinfo.forks_count) + '</span></span>' + '</h2></div><div class="reposidget-content">' + repoContent + '</div>';
